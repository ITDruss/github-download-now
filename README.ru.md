...
1. Распаковать `github-download-now-chromium-v1.0.0.zip`.
...
1. Распаковать `github-download-now-firefox-v1.0.0.zip`.
...
- `https://github.com/*` — интерфейс и публичные данные открытой страницы репозитория;
- `https://api.github.com/*` — публичные метаданные релизов и документации.

Расширение не запрашивает доступ к cookie, истории браузера, общей истории загрузок или GitHub-токенам.
