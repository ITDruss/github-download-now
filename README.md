...
- Places a compact, tag-specific download control beside the selected version on GitHub Releases pages.
...
1. Extract `github-download-now-chromium-v0.4.3.zip`.
...
1. Extract `github-download-now-firefox-v0.4.3.zip`.
